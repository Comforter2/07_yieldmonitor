...
(Basically repeating what we did in class for 2019 and 2020 yield data)
...
## Importing data  
```{r yield19 }
yield19 = read_csv("../data/03_yield19.csv")
...
yield19_w %>%
  ...
  #coord_sf(datum = st_crs(yield17_w)) + #lets you plot it in metres for projected crs
  scale_color_viridis_b()
