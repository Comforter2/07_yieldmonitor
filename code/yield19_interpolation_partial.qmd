...
yield19_c = read_sf("../data/yield19_clean.geojson")
...
```{r exporting}
write_sf(idw_pred_v,
         "../data/yield19_interpolated.geojson",
         delete_dsn = T)
```
...
write_csv(summary_filtered, "../ouput/ipyield19_summary.csv")
...
yieldmap_ip <- ggplot(idw_pred_v)+
  ...
  labs(color = "Yield (lb/ac)",
       title = "2019 Interpolated Yield Map") +
  theme_map() +
...
ggsave("../ouput/ip_yieldmap19.png",
       bg = "white")
```
