...
Before filtering we had a total of 27,690 data rows. How many rows now after filtering? **27,679** rows
...
clean_yield19_summary = summary_filtered %>%
  st_drop_geometry() %>%
  select(-data, -sd, -n) %>%
...
write_csv(clean_yield19_summary, "../ouput/clean_yield19_summary.csv")

read_csv("../ouput/clean_yield19_summary.csv")
```
...
ggsave("../ouput/clean_yieldmap19.png",
       bg = "white")
```
